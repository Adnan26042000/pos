                ...
                <li>
                    <div @if(request()->segment(1) == 'master-data')  x-data="{dropdown : true}"
                        ...
                        <div @click="dropdown = !dropdown"
                             class="text-gray-400 hover:text-white hover:bg-gray-800 group flex rounded-md p-2 text-sm leading-6 font-semibold items-center justify-between flex-row cursor-pointer">
