                    ...
                    <div class="inline-block min-w-full py-2 align-middle px-6 lg:px-8">
                        <div class="border-t">
                            <div class="grid grid-cols-4 mx-4">
                                ...
                                <div class="mx-2 my-2 col-span-4 md:col-span-2 lg:col-span-1">
                                    <label for="tier"
                                           class="block text-sm font-medium leading-6 text-gray-900">Tier <span
                                            class="text-red-700">*</span></label>
                                    <div class="mt-1">
                                        <input type="text" id="tier" autocomplete="off"
                                               wire:model.defer="rack.tier"
                                               class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                                ...
                                <div class="mx-2 my-2 col-span-4 md:col-span-2 lg:col-span-1">
                                    <label for="contact_no"
                                           class="block text-sm font-medium leading-6 text-gray-900">Status <span
                                            class="text-red-700">*</span></label>
                                    <div class="mt-1">
                                        <select wire:model.defer="rack.status"
                    ...
                    <div class="border-t">
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr>
                                ...
                                <th scope="col"
                                    class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Tier
                                </th>
                            ...
                            @if($fetch_rack->isNotEmpty())
                                @foreach($fetch_rack as $r)
                                    <tr>
                                        ...
                                        <td class="relative whitespace-nowrap py-4 pl-3  text-center text-sm font-medium pr-6">
                                            <a href="#" class="text-indigo-600 hover:text-indigo-900"
                                               wire:click.prevent="edit({{$r->id}})">Edit</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
