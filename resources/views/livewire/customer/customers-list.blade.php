                ...
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <div class="border-t">
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            @if($fetch_customers->isNotEmpty())
                                @foreach($fetch_customers as $s)
                                    <tr>
                                        ...
                                        <td class="relative whitespace-nowrap py-4 pl-3  text-center text-sm font-medium pr-6">
                                            <a href="{{route('customer.add-customer',['customer_id'=>$s->id])}}"
                                               target="_blank"
                    ...
                    @if($fetch_customers->isNotEmpty())
                        <div class="h-14 bg-gray-50  border-t px-6 mt-2 py-2">
                            @if($fetch_customers->lastPage() >  1)
                                {{$fetch_customers->links()}}
                            @else
